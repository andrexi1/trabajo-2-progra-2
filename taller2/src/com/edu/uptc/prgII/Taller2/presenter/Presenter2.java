...
import com.edu.uptc.prgII.Taller2.model.Vehicle;
...
public class Presenter2 {
	...
	public static void MENU() throws IOException {
		...
		while (OptionSelection != 4) {
			...
			case 1:
				...
				String aux6 = Scanner.readString("ingrese el tipo de archivo .bin o .txt. "); 
	...
	/**
	 * este emtodo crea y almacena un vehiculo. 
	 * @param brand
	 * @param model
	 * @param year
	 * @param plate
	...
	public static void addVehicle(String brand, String model, int year, String plate, String color, String type) throws IOException {
		...
		Fileworker.writeFile("taller2/src/Vehicles/Vehicle" + (vehicle.getId() + 1) + type, vehicle.toString());
	}

	/**
	 * este emtodo nos enlista los veiculos almacenados. 
	 * @param path
	 */
	public static void getList() {
		String path = "taller2/src/Vehicles";
	...
	/**
	 * este metodo busca un vehiculo almacenado. 
	 * @param name
	 * @throws IOException 
	 */
